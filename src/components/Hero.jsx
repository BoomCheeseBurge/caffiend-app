    ...
    return (
        <>
            ...
            <div className="card info-card">
                ...
                <p>
                    This means that after 5 hours, half the caffeine you consumed is still in you system, keeping you alert longer! 
                    So if you drnk a cup of coffee with 200 mg of caffeine, 5 hours, later, you&apos;ll still hae about 100 mg of caffeine in your system
                </p>
            </div>
        </>
    );
